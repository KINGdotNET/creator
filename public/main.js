...
function hivesigner(amount){
  ...
  var html = `<button type="button" class="btn btn-outline-success btn-block" onclick="window.location.href='https://hivesigner.com/sign/transfer?to=yehey&amount=${price}%20HIVE&memo=account_creation'">Buy codes via HiveSigner!</button>`
